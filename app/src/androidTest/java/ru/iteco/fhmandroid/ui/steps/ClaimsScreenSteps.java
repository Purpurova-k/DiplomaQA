...
public class ClaimsScreenSteps {
    ...
    @Step("Проверка отображения экрана детального описания заявки")
    ...
    @Step("Проверка отображения экрана Заявки")
    ...
    @Step("Нажатие на кнопку Плюс (создать заявку)")
    ...
    @Step("Нажатие на кнопку Редактировать рядом с комментарием")
    ...
    @Step("Нажатие на кнопку редактирования статуса заявки")
    ...
    @Step("Нажатие на стрелку Назад")
    public void clickButtonReturn() {
        claimsScreenElements.getReturnButton().perform(click());
    }

    @Step("Заполнение поля комментарий с последующим нажатием на ОК")
    ...
    @Step("Заполнение поля комментарий с последующим нажатием на Отмена")
    ...
    @Step("Нажатие на кнопку ОК без заполнения значением поля комментарий")
    ...
    @Step("Проверка, что комментарий не создался")
    ...
    @Step("Проверка отсутствия несозданной претензии")
    ...
    @Step("Сравнение названий заявок до и после отмененной фильтрации")
    ...
    @Step("Проверка отображения снэка с ошибкой")
