...
public class ControlPanelScreenSteps {
    ...
    @Step("Проверка отображения экрана Панель управления новостей")
    ...
    @Step("Нажатие на кнопку Плюс (создать новость)")
    ...
    @Step("Нажатие на новость в списке")
    ...
    @Step("Сравнение данных первой новости в списке до и после отмены удаления новости")
    ...
    @Step("Сравнение категории введенной в фильтре и категории найденной новости")
    ...
    @Step("Сравнение названий новостей до и после отмененной фильтрации")
    ...
    @Step("Проверка фильтрации по дате публикации")
    ...
    @Step("Проверка фильтрации по дате публикации с одной введенной датой в фильтрации")
    ...
    @Step("Сравнение данных новости до и после отмены редактирования")
    ...
    @Step("Проверка, что статус новости изменился и она отсутствует в списке новостей")
    ...
    @Step("Сравнение данных у созданной и найденной претензий")
    ...
    @Step("Сравнение данных первой новости до и после отмены создания новой новости")
